...
model_path = "/home/muhammad/DeepLog/deeplog/deeplog_model.pth"
data_file = "/home/muhammad/DeepLog/deeplog/redis_sequences.txt"
...
def detect_anomalies():
    ...
    with open("/home/muhammad/DeepLog/deeplog/anomaly_results.txt", "w") as f:
        try:
            while True:
...
def monitor_redis():
    ...
    model.eval()
    sequence_index = 274
    with open("/home/muhammad/DeepLog/deeplog/anomaly_results.txt", "a") as f:
        while True:
            try:
                sequence = r.lpop("log_sequences")
